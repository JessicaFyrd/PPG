...
<<<<<<< HEAD:Examples/HeartRate10Click_online_filtering.c
...
float32_t data_1s_ir[LENGTH_DATA] = {0};										//Online data buffer for IR LED
float32_t data_1s_red[LENGTH_DATA] = {0};									//Online data buffer for red LED
=======
...
>>>>>>> 3b6c5da07df91d49e3b6708c215ac859558dfba7:Examples/HeartRate10Click_online_filtering_HR.c
...
//Filter buffer
<<<<<<< HEAD:Examples/HeartRate10Click_online_filtering.c
static float32_t data_1s_ir_filtered[LENGTH_DATA] = {0};					//Filter IR data buffer
static float32_t data_1s_red_filtered[LENGTH_DATA] = {0};					//Filter red data buffer
=======
...
int main(void)
{
  ...
  //Filter variables
<<<<<<< HEAD:Examples/HeartRate10Click_online_filtering.c
  inputF32_ir = &data_1s_ir[0]; 								//Initialize input IR buffer pointers
  outputF32_ir = &data_1s_ir_filtered[0]; 								//Initialize output IR buffer pointers
  inputF32_red = &data_1s_red[0]; 							//Initialize input red buffer pointers
  outputF32_red = &data_1s_red_filtered[0]; 								//Initialize output red buffer pointers
=======
...
=======
		  memcpy(&data_10s_ir[0],&data_10s_ir[LENGTH_DATA],(LENGTH_DATA_10s-LENGTH_DATA)*4); //Memory copy in the 1st argument from the second with the size in 3rd argument (in bytes)
>>>>>>> 3b6c5da07df91d49e3b6708c215ac859558dfba7:Examples/HeartRate10Click_online_filtering_HR.c
...
//		  {
<<<<<<< HEAD:Examples/HeartRate10Click_online_filtering.c
//			  data_10s_ir[i+9*LENGTH_DATA]=data_1s_ir_filtered[i];
//			  data_10s_red[i+9*LENGTH_DATA]=data_1s_red_filtered[i];
//		  }
...
//		  }
		  memcpy(&data_10s_ir[LENGTH_DATA_10s-LENGTH_DATA],output_ir,LENGTH_DATA*4);
>>>>>>> 3b6c5da07df91d49e3b6708c215ac859558dfba7:Examples/HeartRate10Click_online_filtering_HR.c
